...
# runifold-retrieval Agent guide
...
Does not own: A mandatory vector database or opinionated RAG application.
...
Extend provider-neutral retrieval, documents and semantic-memory contracts within this crate; consult current public exports before adding another abstraction.
...
```sh
cargo test -p runifold-retrieval --locked
cargo clippy -p runifold-retrieval --all-targets --all-features --locked -- -D warnings
```
