...
Does not own: Agent orchestration and vendor protocols.
...
Extend typed tool descriptors, registry, input validation and safe errors within this crate; consult current public exports before adding another abstraction.
...
cargo clippy -p runifold-tool --all-targets --all-features --locked -- -D warnings
```
