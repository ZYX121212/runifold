...
# runifold-observability-otel Agent guide
...
Does not own: Core event semantics or default prompt capture.
...
Extend optional opentelemetry projection of canonical observations within this crate; consult current public exports before adding another abstraction.
...
```sh
cargo test -p runifold-observability-otel --locked
cargo clippy -p runifold-observability-otel --all-targets --all-features --locked -- -D warnings
```
